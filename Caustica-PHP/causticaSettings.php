...
if($_SERVER['REQUEST_METHOD'] != 'POST'){
	$tabTitle = 'Caustica - Caustica Settings';
	printHeader('');
	...
	<div class="main-column">
	  <div class="post-list-outline">
	    <h2 class="label">Caustica Settings</h2>
  ...
  <div class="dialog-inner">
	...
	if(empty($errors)){
		...
		if (isset($_POST['theme-color']) && $_POST['theme-color'] != '#000000'){
			setcookie('Caustica_color_theme', hexToHsl($_POST['theme-color']), strtotime('+10 days'), '/');
			setcookie('hex_color_theme', $_POST['theme-color'], strtotime('+10 days'));
		} else {
			setcookie('Caustica_color_theme', 'NULL', strtotime('-20 days'), '/');
